<x-app>
    <x-slot:title>Yeni Komisyon Ekle - MertNakliyat</x-slot:title>

    <div class="max-w-xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Yeni Komisyon Kaydı</h1>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            <form action="{{ route('komisyon.store') }}" method="POST" class="space-y-5">
                ...
                <!-- Komisyon Tutarı -->
                <div>
                    <label for="commission_amount" class="block text-sm font-medium text-slate-700 mb-1">Komisyon Tutarı (₺)</label>
